...
. Log into the Element application. Open a new browser window or tab, and navigate to the {elementurl}[*Element chat application*, window="_blank"]. Click on the *Sign In* button. Sign in with your username and password (%user_name%/%user_password%).
+
...
+
You should see the Element workspace.
+
...
+
You can open the Globex Web portal following link:{globexweburl}[*this direct link*, window="_blank"].
+
