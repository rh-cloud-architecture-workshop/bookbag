...
++++
<p align="center">
	<img src="./images/camel/overview-lab-1.png" style="width:90%;border-style: none;">
</p>
++++
...
++++
<p align="center">
	<img src="./images/camel/cache-role.png" style="width:40%;border-style: none;">
</p>
++++
...
.Click here for details about the above route:
[%collapsible]
======
...
++++
<p align="center">
	<img src="./images/camel/cache-seq-diagram.png" style="width:40%;border-style: none;">
</p>
++++
...
+
image::images/camel/rocketchat-workspace.png[]
+
...
+
image::images/camel/element-desktop-notifications.png[]
+
You should see the Matrix's Element workspace.
+
image::images/camel/element-workspace.png[]
+
Leave the browser window open.
...
IMPORTANT: When you're done, press `Ctrl`+`C` to stop the _Camel K_ `dev` instance running in the Devspaces's terminal. +
...
. From your Devspaces terminal, execute the `kamel` command below to create a new source file to process Matrix events:
+
[source,bash,role=copy,subs=]
----
...
.Click here view a summary of the differences:
[%collapsible]
======
...
+
++++
<img src="./images/camel/matrix-deploy-test-end-to-end.png" style="width:100%;border-style: none;">
++++
...
++++
<p align="center">
	<img src="./images/camel/overview-lab-2.png" style="width:90%;border-style: none;">
</p>
++++
...
++++
<p align="center">
	<img src="./images/camel/common-data-model.png" style="width:90%;border-style: none;">
</p>
++++
...
IMPORTANT: Close in your editor all open files/tabs in Devspaces to ensure your IDE is clean.

Start your implementation:

. Run in your Devspaces terminal the snippet below to set the working directory for this task:
+
[source,bash,role=copy,subs=attributes]
----
...
. From your Devspaces terminal, execute the command below to create a new (empty) source file that will contain the JSLT definition:
+
[source,java,role=copy,subs=]
----
...
++++
<p align="center">
	<img src="./images/camel/overview-lab-3.png" style="width:90%;border-style: none;">
</p>
++++
