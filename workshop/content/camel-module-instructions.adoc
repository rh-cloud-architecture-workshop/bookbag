...
This time, the `deploy.sh` command made the Camel K operator to fully deploy your code, which you can see running in a pod from the link:{topologyviewurl}[*_Topology_ view*, window="_blank"].
-- 
