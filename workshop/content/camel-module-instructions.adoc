...
+
++++
<img src="./images/camel/globex-signin.jpg" style="width:50%;border-style: none;">
++++
+
{empty} +
...
[start=4]
. From Discord...
.. You should see in Discord a new channel `globex-%user_name%` created.
...
. Back from Globex...
+
You should see the agent's message sent from Discord appear in the chat session window.
