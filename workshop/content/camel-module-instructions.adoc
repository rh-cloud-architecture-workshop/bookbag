...
+
image::./images/camel/slack-onboard.jpg[align="left", width=50%]
+
...
--
+
image::./images/camel/slack-add-app.jpg[align="left", width=40%]
+
.. Then, select from the menu the `GlobexSupport` app.
+
image::./images/camel/slack-add-globex.jpg[align="left", width=40%]
+
...
// --
+
image::./images/camel/slack-app-globex-visible.jpg[align="left", width=40%]
...
- View app details
+
image::./images/camel/slack-app-view-details.jpg[align="left", width=50%]


. A window pops up. +
At the very bottom, copy your personal GlobexSupport `Channel ID`.
+
image::./images/camel/slack-app-channel-id-copy.jpg[align="left", width=50%]
...
image::./images/camel/cache-role.jpg[align="center", width=50%]
...
image::./images/camel/discord-onboard.jpg[align="left", width=50%]
...
[WARNING]
====
If you see no message in Discord you might have misconfigured your Slack channel ID in the `my.properties` configuration file. Review the instructions and try again. The configuration property should look similar to:
