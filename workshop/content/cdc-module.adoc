...
As mentioned in the link:workshop-introduction[introduction module] of the workshop, Globex went through a first modernization phase for their retail web application, moving from a legacy monolith to a containerized application.
...
Proceed to the link:cdc-module-instructions[instructions] for this module.
