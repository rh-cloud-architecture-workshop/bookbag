...
As mentioned in the xref:workshop-introduction.adoc[introduction module] of the workshop, Globex went through a first modernization phase for their retail web application, moving from a legacy monolith to a containerized application.
...
Proceed to the xref:cdc-module-instructions.adoc[instructions] for this module.
