...
Congratulations! You successfully used Red Hat Service Interconnect to build a secure service network between two services on two different OpenShift clusters on two different clouds and allowed applications to connect and communicate over the secure network.