...
docker pull default-route-openshift-image-registry.apps.cluster-ks5fc.ks5fc.sandbox1482.opentlc.com/create-bookbag/bookbag:latest
...
podman push quay.io/cloud-architecture-workshop/bookbag:jc-wip
